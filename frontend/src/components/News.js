    ...
    onOpenModal = (newsId) => {
        if (newsId === "covid19"){
            ...
            this.modalBody =    "<p>Tempos difíceis chegaram. Estamos enfrentando uma crise sem previsão de término.</p>" +
                                ...
                                "<div class='div--img-news-container'><img class='modal--news-img' src='https://cdn.portalcbncampinas.com.br/wp-content/uploads/2020/01/portalcbncampinas.com.br-corona-virus-e-febre-hemorragica-coronavirus.jpg'></div>" +
            ...
            this.modalBody =    "<p>As novas cadeiras com suspensão a ar e flexibilidade rotativa estão dando o que falar no mercado odontológico!" +
                                ...
                                "<div class='div--img-news-container'><img class='modal--news-img' src='https://mundirepresentacoes.com.br/images/produtos/linha-odontologica/consultorios/Cadeira-Frente.png'></div>"; 
        }
        ...
        return (
            <div className="container--miolo-main">
                ...
                <Modal open={ this.state.modalVisibility } onClose={ this.onCloseModal } center>
                    <div className="modal--header-for-calls">
                        <h1>{ this.modalTitle }</h1>
                    </div>            
                    <div className="modal--body-custom">
                        <div className="modal--body-custom-content" dangerouslySetInnerHTML={{ __html: this.modalBody }} />
                    </div>
                </Modal>
            </div>
        );
